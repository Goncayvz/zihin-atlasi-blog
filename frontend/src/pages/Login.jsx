    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-300 via-blue-200 to-sky-200">
      <div className="bg-white/40 backdrop-blur-md rounded-2xl p-10 shadow-xl text-center w-[350px] border border-white/50">
        ...
        <svg viewBox="0 0 200 200" className="w-28 h-28 mx-auto mb-5 drop-shadow-md">
          ...
          <g>
            <polygon points="100,30 95,100 105,100" fill="#9f48f7" />
            <polygon points="100,170 95,100 105,100" fill="#5096eb" />
            <animateTransform attributeName="transform" type="rotate" from="0 100 100" to="360 100 100" dur="4s" repeatCount="indefinite" />
          </g>
        </svg>

        <h2 className="text-2xl font-semibold mb-5 text-purple-800">Hoş Geldiniz ✨</h2>
        <form>
          {/* Kullanıcı Adı */}
          <input 
            type="text" 
        ...
        <p className="mt-4 text-sm text-purple-700">
          Hesabınız yok mu? <Link to="/register" className="text-blue-600 font-semibold hover:underline">Kayıt Ol</Link>
        </p>
      </div>
    </div>
  )
